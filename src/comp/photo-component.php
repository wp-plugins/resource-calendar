...
class Photo_Component extends ResourceCalendar_Component  {
	...
	public function editTableData($set_file_name,$set_resize_file_name) {
		...
		$set_data['photo_path'] = RCAL_UPLOAD_URL.$set_file_name;
		$set_data['photo_resize_path'] = RCAL_UPLOAD_URL.$set_resize_file_name;
		$set_data['width'] = 0;
		$set_data['height'] = 0;
		$set_data['delete_flg'] = ResourceCalendar_Reservation_Status::TEMPORARY;
